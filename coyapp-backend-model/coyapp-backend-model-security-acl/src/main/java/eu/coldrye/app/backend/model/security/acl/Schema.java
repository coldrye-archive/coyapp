 ...
 */
package eu.coldrye.app.backend.model.security.acl;

/**
 * TBD:refactor to security-acl-schema
 *
...
public interface Schema
{
    ...
    public interface Acl
    {
        ...
        public static final String ASSIGN_OWNER = "TBD:WELL-KNOWN-UUID";
        public static final String MANAGE_PERMISSIONS = "TBD:WELL-KNOWN-UUID";
        public static final String VIEW_PERMISSIONS = "TBD:WELL-KNOWN-UUID";
    }
}
