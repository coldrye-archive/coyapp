...
import eu.coldrye.app.backend.model.security.spi.SecServiceDAO;
 ...
 * @since 0.0.1
 */
public final class SecServiceDAOImpl
        extends AbstractSecUserDAOCommon
        implements SecServiceDAO
{

    public SecServiceDAOImpl()
    {
        super(User.UserType.SERVICE);
    }
}
