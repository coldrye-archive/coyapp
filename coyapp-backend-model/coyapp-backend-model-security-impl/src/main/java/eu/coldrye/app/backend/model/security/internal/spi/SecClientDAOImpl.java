...
import eu.coldrye.app.backend.model.security.spi.SecClientDAO;
 ...
 * @since 0.0.1
 */
public final class SecClientDAOImpl
        extends AbstractSecUserDAOCommon
        implements SecClientDAO
{

    public SecClientDAOImpl()
    {
        super(User.UserType.CLIENT);
    }
}
