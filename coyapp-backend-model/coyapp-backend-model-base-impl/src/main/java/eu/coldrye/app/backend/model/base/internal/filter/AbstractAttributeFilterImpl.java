 ...
 */
public class AbstractAttributeFilterImpl<ID extends Serializable, T extends AbstractEntity>
        implements Filter<ID, T>,
                   FilterImplementor
{
    ...
    protected AbstractAttributeFilterImpl(String attribute, Serializable value)
    {
