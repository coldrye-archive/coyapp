 ...
 */
@Entity
@Table(name = "coy_instance", uniqueConstraints =
{
   @UniqueConstraint(name = "UK_COY_INSTANCE_PARENT_NAME",
                     columnNames =
                     {
                         "parent_id", "name"
                     })
...
@DiscriminatorColumn(name = "instance_type", length = Named.MAX)
public class Instance
        extends AbstractUnique
        implements Node<Instance>,
                   FqNamed,
                   Describable
{
    ...
    public void setSubsystem(final Subsystem subsystem)
    {
